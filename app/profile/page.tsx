...
const AVATAR_COLLECTIONS = {
    boys: [
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Felix&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Ryan&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Jake&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Mason&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Liam&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Noah&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Ethan&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Oliver&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=James&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Lucas&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Henry&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Alex&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Seb&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Jacky&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Owen&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
        "https://api.dicebear.com/9.x/avataaars/svg?seed=Theo&top[]=shortHair&top[]=shortHairTheCaesar&top[]=shortHairShortCurly&top[]=shortHairShortFlat&top[]=shortHairShortRound&top[]=shortHairShortWaved&top[]=shortHairSides&top[]=shortHairTheCaesarSidePart&facialHairProbability=0",
    ],
    girls: [
