...
function RegisterContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            // สมัครด้วยอีเมล+รหัสผ่านเท่านั้น — ชื่อ/เบอร์ไปกรอกครั้งเดียวตอนแจ้งโอน
            // (หน้า /payment เขียนกลับเข้าโปรไฟล์ให้หลังบ้านเห็นเอง)
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-12 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all font-medium text-slate-800 placeholder:text-slate-400"
                                placeholder="••••••••"
                            />
                            <button
                                type="button"
                        ...
                        <p className="text-xs text-slate-400 ml-1">กดรูปดวงตาเพื่อดูรหัสผ่านที่พิมพ์ เช็คภาษาไทย/อังกฤษให้ชัวร์</p>
                    </div>
