...
// หมวด = ชั้นวางบนหน้าร้าน (ExamPapersShop จัดกลุ่มตามค่านี้ตรงๆ) — พิมพ์ต่างกันนิดเดียว
// ชั้นจะแตกเป็นสองชั้น ชั้นละใบ จึงให้เลือกจากรายการแทนพิมพ์เอง
// "สรุปบท …" คือซีรีส์เอกสารสรุปบทเรียน ขายทีละบท ไม่ใช่ชุดเก็งข้อสอบ
const CATEGORIES = ["O-NET", "A-Level", "สอบกลางภาค", "สอบปลายภาค", "สอบเข้า", "สอบเข้า ม.1", "สอบเข้า ม.4", "แนวข้อสอบ", "สรุปบท ม.1 เทอม 1", "สรุปบท ม.1 เทอม 2", "อื่นๆ"];
