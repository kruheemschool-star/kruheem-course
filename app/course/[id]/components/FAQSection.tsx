...
const faqData: FAQItem[] = [
...

    {
        ...
        answer: 'ได้ครับ... ถ้าคุณยอมจ่ายในราคา 1,900 บาท (เพราะสิทธิ์ 30 คนเต็มแน่นอน) และถ้าคุณยอมให้ลูกต้องไป "เร่งอัด" ความรู้ช่วงใกล้สอบ การอัดเนื้อหาใกล้สอบก็เหมือน "การบังคับให้กินข้าว 3 มื้อรวดเดียว" เด็กจะจุกและอ้วกออกมา (สอบตก) เริ่มวันนี้ วันละ 15 นาที ลูกคุณจะเดินเข้าห้องสอบแบบชิลล์ๆ ครับ',
    },
    {
    ...
    },
    {
        ...
        answer: 'แน่นอนครับ! เพราะ 30 คนแรกที่สมัคร จะได้สิทธิ์ "Line ส่วนตัวครูฮีม" ติดตรงไหน ถ่ายรูปโจทย์ส่งมาได้เลย ผมจะไกด์วิธีคิดให้ทีละสเต็ป เหมือนมีผมสแตนด์บายอยู่ในกระเป๋ากางเกงลูกคุณตลอดเวลา (เฉพาะโบนัสข้อนี้ก็คุ้มเกิน 690 บาทไปไกลแล้วครับ)',
    },
    {
    ...
    },
    {
        ...
        answer: 'ผมกล้าท้าครับ! ถ้าภายใน 7 วัน ลูกเรียนแล้วรู้สึกว่า "ครูฮีมสอนไม่รู้เรื่องเลย" ทักแชทมาบอกผม ผมโอนเงินคืนให้เต็มจำนวน 690 บาททันที ไม่มีเงื่อนไข ไม่ถามจุกจิก... ความเสี่ยงของคุณคือ 0%',
    },
];
