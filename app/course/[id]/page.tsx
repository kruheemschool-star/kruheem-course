            ...
            curriculum: [
                {
                    ...
                    content: [
                        "จำนวนนับคืออะไร? ค่าประจำหลัก และการประมาณค่า",
                        "สมบัติของจำนวนนับ และลำดับการคำนวณ (Order of Operations)",
                        "แบบรูป, โจทย์ปัญหาระคน, และคลังข้อสอบเข้า ม.1"
                    ]
                },
                {
                    id: 2,
                    ...
                    content: [
                        "สมการคืออะไร? หลักการแก้สมการพื้นฐาน",
                        "เทคนิคการย้ายข้าง, การแก้สมการที่มีเศษส่วนและวงเล็บ",
                        "ขั้นตอนการแก้โจทย์ปัญหาสมการ (จำนวน, อายุ, เงิน, ฯลฯ)"
                    ]
                },
                {
                    id: 3,
                    ...
                    content: [
                        "ตัวประกอบ, จำนวนเฉพาะ, การแยกตัวประกอบ",
                        "ตัวหารร่วมมาก (ห.ร.ม.) และ ตัวคูณร่วมน้อย (ค.ร.น.)",
                        "โจทย์ปัญหา ห.ร.ม. และ ค.ร.น. ในสถานการณ์ต่างๆ"
                    ]
                },
                {
                    id: 4,
                    ...
                    iconColor: "text-emerald-500",
                    content: [
                        "จุด, เส้นตรง, รังสี, และชนิดของมุม",
                        "เส้นตัด, มุมตรงข้าม, และมุมประชิด",
                        "การคำนวณมุมในรูปสามเหลี่ยมและหลายเหลี่ยม"
                    ]
                },
                {
                    id: 5,
                    ...
                    iconColor: "text-teal-500",
                    content: [
                        "นิยามและเครื่องมือตรวจสอบเส้นขนาน",
                        "มุมแย้ง, มุมภายใน, มุมสมนัย",
                        "เทคนิคตะลุยโจทย์: มุมคลาสสิก, สามเหลี่ยม, มุมหักงอ"
                    ]
                },
                {
                    id: 6,
                    ...
                    iconColor: "text-green-500",
                    content: [
                        "รู้จักทิศทั้ง 8 และการวัดมุม",
                        "มาตราส่วน (Scale) และการคำนวณระยะทางจริง",
                        "โจทย์ปัญหาการเดินทางและพื้นที่"
                    ]
                },
                {
                    id: 7,
                    ...
                    iconColor: "text-emerald-500",
                    content: [
                        "ชนิดของเศษส่วน, การเปรียบเทียบ, การเรียงลำดับ",
                        "การบวก ลบ คูณ หาร เศษส่วน",
                        "โจทย์ปัญหาเศษส่วนและการวิเคราะห์ Keyword"
                    ]
                },
                {
                    id: 8,
                    ...
                    iconColor: "text-teal-500",
                    content: [
                        "ค่าประจำหลัก, การเปรียบเทียบ, การประมาณค่า",
                        "การแปลงทศนิยมเป็นเศษส่วน (และกลับกัน)",
                        "การบวก ลบ คูณ ทศนิยม และโจทย์ปัญหา"
                    ]
                },
                {
                    id: 9,
                    ...
                    iconColor: "text-green-500",
                    content: [
                        "การหารทศนิยม (แปลงเป็นเศษส่วน / เลื่อนจุด)",
                        "โจทย์การหารระคน",
                ...
                },
                {
                    ...
                    iconColor: "text-emerald-500",
                    content: [
                        "คุณสมบัติของสี่เหลี่ยม 6 ชนิด",
                        "สูตรหาพื้นที่และความยาวรอบรูป",
                        "โจทย์ปัญหาพื้นที่ซับซ้อนและเส้นทแยงมุม"
                    ]
                },
                {
                    id: 11,
                    ...
                    iconColor: "text-teal-500",
                    content: [
                        "ชนิดของรูปสามเหลี่ยม (แบ่งตามด้าน/มุม)",
                        "การหามุมภายใน, ความยาวรอบรูป, และพื้นที่",
                        "โจทย์ปัญหาพื้นที่แรเงาและการแก้สมการย้อนกลับ"
                    ]
                },
                {
                    id: 12,
                    ...
                    iconColor: "text-green-500",
                    content: [
                        "ส่วนประกอบของวงกลม (รัศมี, เส้นผ่านศูนย์กลาง, คอร์ด)",
                        "สูตรความยาวรอบวงและพื้นที่",
                        "โจทย์ประยุกต์: สนามวิ่ง, วงแหวน, พื้นที่แรเงา"
                    ]
                },
                {
                    id: 13,
                    ...
                    iconColor: "text-emerald-500",
                    content: [
                        "โจทย์ปัญหาร้อยละ/เปอร์เซ็นต์",
                        "การคำนวณกำไร, ขาดทุน, ลดราคา (ลดซ้อนลด)",
                ...
                },
                {
                    ...
                    iconColor: "text-teal-500",
                    content: [
                        "รูปทรงสี่เหลี่ยมมุมฉาก, ลูกบาศก์",
                        "การหาปริมาตร, ความจุ, และการแปลงหน่วย",
                        "การหาพื้นที่ผิวและโจทย์ประยุกต์"
                    ]
                },
                {
                    id: 15,
                    ...
                    iconColor: "text-green-500",
                    content: [
                        "แผนภูมิรูปภาพ, แท่ง, กราฟเส้น, วงกลม",
                        "การเปรียบเทียบข้อมูล, หาค่าเฉลี่ย, ร้อยละ",
                        "การคาดการณ์แนวโน้มจากข้อมูล"
                    ]
                },
                {
                    id: 16,
                    ...
                    iconColor: "text-emerald-500",
                    content: [
                        "โอกาสของเหตุการณ์ (แน่นอน, อาจจะ, ไม่เกิด)",
                ...
                {
                    id: 17,
                    title: "💡 แถมฟรี! 40 แนวโจทย์ห้อง Gifted",
                    desc: "เนื้อหาพิเศษสำหรับน้องที่ต้องการความท้าทาย",
                    color: "bg-yellow-100/70",
                    iconColor: "text-yellow-600",
                    content: [
                        "PART 1: รากฐานคณิตศาสตร์ (เลขยกกำลัง, ห.ร.ม., ค.ร.น., แบบรูป)",
                        "PART 2: เศษส่วนและอนุกรมขั้นสูง (เศษส่วนซ้อน, เทเลสโกปิก)",
                        "PART 3: สมการและโจทย์ปัญหา (สมการเชิงเส้น, ระบบสมการ)",
                        "PART 4: คณิตศาสตร์ประยุกต์ (อัตราส่วน, ร้อยละ, ดอกเบี้ย)",
                        "PART 5: เรขาคณิต (พีทาโกรัส, สามเหลี่ยมคล้าย, วงกลม)",
                        "PART 6: กลยุทธ์พิชิตข้อสอบ (พื้นที่แรเงา, ความน่าจะเป็น, โจทย์ปัญหา)"
                    ]
                }
            ],
            importance: [
