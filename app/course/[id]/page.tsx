...
export default function CourseSalesPage() {
    ...
    if (isMasteringEquations) {
        ...
        content = {
            ...
            painPoint: {
                title: "ติวเข้มสอบเข้า Gifted ม.1 🔥",
                subtitle: "คอร์สออนไลน์ที่ครบจบในที่เดียว สำหรับน้องๆ ที่ต้องการสอบเข้าห้องเรียนพิเศษ (Gifted / MEP / EP) และปูพื้นฐานคณิตศาสตร์ให้แน่นก่อนขึ้น ม.ปลาย",
                blobs: ["bg-emerald-100/30", "bg-teal-100/30"],
                problemBox: {
                    title: "คอร์สนี้เหมาะกับใคร? 🧠",
                    icon: "🧠",
                    items: [
                        { icon: "🎯", text: "น้องๆ ที่ต้องการสอบเข้าโรงเรียนชั้นนำ ห้อง Gifted / MEP / EP" },
                        { icon: "👨‍👩‍👧", text: "ผู้ปกครองที่มองหาคอร์สที่ครบจบในที่เดียว ไม่ต้องหาที่ติวเพิ่ม" },
                        { icon: "📚", text: "น้องๆ ที่ต้องการปูพื้นฐานเลขให้แน่นปึ้กก่อนขึ้น ม.ปลาย" },
                        { icon: "🚀", text: "คนที่ต้องการเทคนิคคิดวิเคราะห์และแก้โจทย์ซับซ้อน" }
                    ],
                    bg: "bg-white/50"
                },
                solutionBox: {
                    title: "คอร์สนี้จะให้อะไรบ้าง? 🎁",
                    icon: "🎁",
                    desc: "เนื้อหาเข้มข้น ครอบคลุมทุกมิติ พร้อมเทคนิคที่ใช้ได้จริงในสนามสอบ",
                    items: [
                        { icon: "🏫", text: "ครอบคลุมทุกสนามสอบ: สพฐ., สสวท. และโรงเรียนดัง" },
                        { icon: "📈", text: "เจาะลึก 6 พาร์ท: สอนคิดวิเคราะห์ตั้งแต่พื้นฐานถึงขั้นสูง" },
                        { icon: "💻", text: "เรียนได้ทุกที่ ทุกเวลา: ผ่านระบบออนไลน์ 24/7" },
                        { icon: "🗓️", text: "คุ้มค่าที่สุด: เรียนได้ยาวๆ 5 ปีเต็ม ทบทวนได้ตลอด" }
                    ],
                    bg: "bg-emerald-50/50",
            ...
            curriculum: [
                {
                    ...
                    desc: "ปูพื้นฐานการคำนวณและตัวเลขให้แม่นยำ",
                    color: "bg-emerald-100/70",
                    iconColor: "text-emerald-500",
                    content: [
                        "บทที่ 1: หลักการคำนวณ (Order of Operations) – แนวโจทย์คำนวณซ้อน",
                        "บทที่ 2: เลขยกกำลัง (Exponents) – สมบัติเลขยกกำลังและการลดรูป",
                        "บทที่ 3: ตัวประกอบ (Factoring) – วิเคราะห์โครงสร้างตัวเลข",
                        "บทที่ 4: ห.ร.ม. และ ค.ร.น. (GCD & LCM) – โจทย์ประยุกต์การแบ่งกลุ่ม",
                        "บทที่ 5: แบบรูปและความสัมพันธ์ (Number Patterns) – หาพจน์ถัดไป",
                        "บทที่ 6: ลำดับฟีโบนักชี (Fibonacci Sequence) – ความเข้าใจลำดับพิเศษ",
                        "บทที่ 7: ลำดับและอนุกรมเลขคณิต (Arithmetic Sequences) – หาผลรวมอนุกรม",
                        "บทที่ 8: การนับจำนวนและการหารลงตัว (Divisibility) – เงื่อนไขการหาร"
                    ]
                },
                {
                    id: 2,
                    title: "PART 2: เศษส่วน ทศนิยม และอนุกรมขั้นสูง 📈",
                    desc: "เทคนิคการจัดการตัวเลขที่ซับซ้อนและอนุกรมยาก",
                    color: "bg-teal-100/70",
                    iconColor: "text-teal-500",
                    content: [
                        "บทที่ 9: เศษส่วนซ้อน (Continued Fractions) – แก้สมการเศษส่วนซับซ้อน",
                        "บทที่ 10: อนุกรมเทเลสโกปิก (Telescopic Series) – เทคนิคการหักล้างพจน์",
                        "บทที่ 11: การแยกเศษส่วนย่อย (Partial Fractions) – เขียนในรูปผลบวกเศษส่วน",
                        "บทที่ 12: ทศนิยมซ้ำ (Repeating Decimals) – หาเลขโดดและการแปลงเป็นเศษส่วน"
                    ]
                },
                {
                    id: 3,
                    title: "PART 3: สมการและการแก้โจทย์ปัญหา ⚖️",
                    desc: "เปลี่ยนโจทย์ปัญหาให้เป็นสมการและหาคำตอบ",
                    color: "bg-green-100/70",
                    iconColor: "text-green-500",
                    content: [
                        "บทที่ 13: สมการเชิงเส้นตัวแปรเดียว (Linear Equations) – โจทย์ปัญหาข้อความ",
                        "บทที่ 14: ระบบสมการสองตัวแปร (Systems of Equations) – โจทย์สัตว์, เหรียญ, อายุ"
                    ]
                },
                {
                    id: 4,
                    title: "PART 4: คณิตศาสตร์ประยุกต์ในชีวิตจริง 📊",
                    desc: "การประยุกต์ใช้คณิตศาสตร์ในสถานการณ์ต่างๆ",
                    color: "bg-emerald-100/70",
                    iconColor: "text-emerald-500",
                    content: [
                        "บทที่ 15: อัตราส่วนและสัดส่วน (Ratio and Proportion) – ของผสม, แผนที่",
                        "บทที่ 16: ร้อยละและเปอร์เซ็นต์ (Percentages) – สถานการณ์ร้อยละต่างๆ",
                        "บทที่ 17: กำไร-ขาดทุน (Profit & Loss) – การซื้อขาย, ลดราคา, ภาษี",
                        "บทที่ 18: ดอกเบี้ย (Simple Interest) – ดอกเบี้ยเงินฝากและเงินกู้"
                    ]
                },
                {
                    id: 5,
                    title: "PART 5: เรขาคณิตและการให้เหตุผล 📐",
                    desc: "ทฤษฎีบท พื้นที่ ปริมาตร และการพิสูจน์",
                    color: "bg-teal-100/70",
                    iconColor: "text-teal-500",
                    content: [
                        "บทที่ 19: ทฤษฎีบทพีทาโกรัส (Pythagorean Theorem) – สามเหลี่ยมมุมฉาก",
                        "บทที่ 20: สามเหลี่ยมคล้าย (Similar Triangles) – การวัดระยะทางโดยอ้อม",
                        "บทที่ 21: การวัดรูปหลายเหลี่ยม (Polygon Measurement) – พื้นที่และเส้นรอบรูป",
                        "บทที่ 22: รูปหลายเหลี่ยมด้านเท่า (Regular Polygons) – มุมภายในและพื้นที่",
                        "บทที่ 23: รูปหลายเหลี่ยมที่มีด้านขนาน – สี่เหลี่ยมคางหมู",
                        "บทที่ 24: ทฤษฎีบทวงกลม (Circle Theorems) – มุมและความยาวส่วนโค้ง",
                        "บทที่ 25: รูปหลายเหลี่ยมในวงกลม (Polygons and Circles) – โจทย์ผสมผสาน",
                        "บทที่ 26: รูปทรงประกอบ (Composite Shapes) – พื้นที่รูปตัดต่อ",
                        "บทที่ 27: มุมและเส้นขนาน (Angles and Parallel Lines) – การไล่มุม",
                        "บทที่ 28: รูปทรงสามมิติ (3D Shapes) – พื้นที่ผิวและปริมาตร"
                    ]
                },
                {
                    id: 6,
                    title: "PART 6: กลยุทธ์และเทคนิคพิชิตข้อสอบ 🎯",
                    desc: "เทคนิคขั้นสูงและการวิเคราะห์โจทย์รูปแบบพิเศษ",
                    color: "bg-green-100/70",
                    iconColor: "text-green-500",
                    content: [
                        "บทที่ 29: การหาพื้นที่แรเงา (Shaded Areas) – เทคนิคบวก-ลบพื้นที่",
                        "บทที่ 30: เรขาคณิตวิเคราะห์เบื้องต้น (Coordinate Geometry) – พื้นที่จากพิกัด",
                        "บทที่ 31: ปริมาตรทรงพีระมิด กรวย ทรงกลม – รูปทรงสามมิติขั้นสูง",
                        "บทที่ 32: แผนภูมิวงกลม (Pie Charts) – การวิเคราะห์ข้อมูล",
                        "บทที่ 33: ความน่าจะเป็น (Probability) – โอกาสของเหตุการณ์",
                        "บทที่ 34: การคิดย้อนกลับ (Reverse Thinking) – หาค่าเริ่มต้นจากผลลัพธ์",
                        "บทที่ 35: อัตราเร็ว ระยะทาง และเวลา – โจทย์เดินทาง, รถไฟสวนกัน",
                        "บทที่ 36: โจทย์การเดินทางมาพบกัน (Meeting Up Problems)",
                        "บทที่ 37: โจทย์การเดินทางไล่ทัน (Catching Up Problems)",
                        "บทที่ 38: ปริศนานาฬิกา (Clock Problems) – มุมและเข็มนาฬิกา",
                        "บทที่ 39: โจทย์ตารางเวลา (Timetable Problems) – วิเคราะห์เงื่อนไข",
                        "บทที่ 40: โจทย์ปัญหาการทำงาน (Work Problems) – อัตราการทำงาน"
                    ]
                }
            ],
            ...
            importance: [
                {
                    title: "เริ่มก่อน ลุยก่อน ก็ถึงเส้นชัยก่อน 🏁",
                    desc: "อย่ารอให้ใกล้สอบแล้วค่อยติว เพราะพื้นฐานที่ดีต้องใช้เวลาสร้าง คอร์สนี้จะช่วยน้องๆ เตรียมความพร้อมตั้งแต่เนิ่นๆ",
                    color: "bg-emerald-50 text-emerald-800 border-emerald-200"
                },
                {
                    title: "เนื้อหาครบ จบในที่เดียว 🌟",
                    desc: "ไม่ต้องสมัครหลายคอร์ส ไม่ต้องเดินทางไปติวหลายที่ รวบรวมทุกสิ่งที่ต้องรู้สำหรับการสอบเข้า ม.1 ไว้ให้แล้ว",
