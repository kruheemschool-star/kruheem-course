...
export default function ChatWidget() {
    ...
    const playNotificationSound = () => {
        try {
            const audio = new Audio("https://assets.mixkit.co/active_storage/sfx/2869/2869-preview.mp3"); // เสียงกระดิ่งนุ่มๆ (Happy Bell)
                        ...
                        <div className="relative">
                            <div className="w-12 h-12 -ml-4 -my-4 flex items-center justify-center">
                                <img
                                    ...
                                    alt="Admin"
                                    className="w-24 h-24 max-w-none object-cover drop-shadow-xl transform -translate-y-3 -translate-x-1 group-hover:scale-[1.8] transition-transform duration-300"
                                />
                            </div>
                            {/* Online status */}
