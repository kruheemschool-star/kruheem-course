            ...
            <div className="p-8 md:p-10">
                ...
                {question.svg && typeof question.svg === 'string' && question.svg.trim().startsWith('<svg') && (
                    <div className="my-8 flex justify-center w-full">
                        <div className="relative w-full max-w-[560px] rounded-2xl border border-slate-200 dark:border-slate-600 shadow-sm bg-white p-3 sm:p-4 mx-auto">
                            <div
                                className="w-full [&>svg]:block [&>svg]:mx-auto [&>svg]:w-full [&>svg]:h-auto [&>svg]:max-h-[420px]"
