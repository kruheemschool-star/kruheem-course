...
const SETS = {
    ...
    frac: {
        title: 'แนวข้อสอบ: เศษส่วน',
        order: 213,
        file: 'webquiz_m1t1_fraction_200q.json',
        subject: 'เศษส่วน',
        count: 200,
        subtopics: ['ความหมายและเศษส่วนที่เท่ากัน', 'การเปรียบเทียบเศษส่วน', 'การเรียงลำดับเศษส่วน',
            'การบวกลบเศษส่วน', 'การคูณเศษส่วน', 'การหารเศษส่วน', 'เศษส่วนจำนวนคละ',
            'เศษส่วนที่เป็นลบ', 'โจทย์ปัญหาเศษส่วน'],
    },
    geo: {
        title: 'แนวข้อสอบ: การสร้างทางเรขาคณิต',
        order: 214,
        file: 'webquiz_m1t1_geoconstruct_200q.json',
        subject: 'การสร้างทางเรขาคณิต',
        count: 200,
        subtopics: ['จุด เส้นตรง ส่วนของเส้นตรง และรังสี', 'มุมและชนิดของมุม', 'การวัดและคำนวณขนาดมุม',
            'การสร้างและแบ่งครึ่งส่วนของเส้นตรง', 'การสร้างมุมเท่าเดิมและการแบ่งครึ่งมุม', 'การสร้างเส้นตั้งฉาก',
            'การสร้างมุมขนาดต่างๆ', 'การสร้างรูปเรขาคณิต', 'โจทย์ปัญหาการสร้างทางเรขาคณิต'],
    },
    sol: {
        title: 'แนวข้อสอบ: รูปเรขาคณิตสองมิติและสามมิติ',
        order: 215,
        file: 'webquiz_m1t1_solid_200q.json',
        subject: 'รูปเรขาคณิตสองมิติและสามมิติ',
        count: 200,
        subtopics: ['รูปเรขาคณิตสองมิติและสามมิติ', 'ส่วนประกอบของรูปเรขาคณิตสามมิติ',
            'หน้าตัดของรูปเรขาคณิตสามมิติ', 'ภาพที่ได้จากการมองด้านหน้า',
            'ภาพที่ได้จากการมองด้านข้างและด้านบน', 'การนับลูกบาศก์จากภาพที่มองเห็น',
            'รูปคลี่ของทรงสี่เหลี่ยมมุมฉากและลูกบาศก์', 'รูปคลี่ของปริซึม พีระมิด และทรงกระบอก',
            'โจทย์ปัญหารูปเรขาคณิตสองมิติและสามมิติ'],
    },
};
